...
set :domain, '128.199.199.146'
set :deploy_to, '/var/www/koinworks.com'
# https://github.com/weyewe/esman.git
# https://github.com/weyewe/repay-v1.git
#'git://github.com/weyewe/repay-v1.git'
# 9400ad42704032c18a15852fe55009ea9de3736a
set :repository,  "https://d103f91609a2a57b77490c5e0321c28de55494a6@github.com/rajakuraemas/temp-landingpage.git"
# set :repository, 'https://github.com/weyewe/repay-v1.git'
set :branch, 'master'
set :user , 'deployer'
set :ssh_options, '-A'
...
set :shared_paths, ['config/database.yml', 'log', 'config/secrets.yml',
 ...
 'config/local_env.yml', 'config/initializers/app_secrets.rb']
...
task :setup => :environment do
  ...
  queue  %[echo "-----> Be sure to edit 'shared/config/database.yml'."]
   ...
   queue! %[touch "#{deploy_to}/shared/config/transloadit.yml"]
  queue  %[echo "-----> Be sure to edit 'shared/config/transloadit.yml'."]
